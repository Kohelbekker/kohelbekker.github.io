...
void			shape2_calc(t_sdl *sdl, t_ray *ray, t_shape *closest_shape)
{
...
void			shape4_calc(t_sdl *sdl, t_ray *ray, t_shape *closest_shape)
{
	double		a;
	double		b;
	double		c;
...
void			shape3_calc(t_sdl *sdl, t_ray *ray, t_shape *closest_shape)
{
	double		a;
	double		b;
	t_vector	c;
